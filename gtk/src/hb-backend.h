...
void ghb_update_status (hb_state_t *state, ghb_instance_status_t *status);
void ghb_track_status(void);
void ghb_backend_scan(const char *path, int titleindex, int preview_count, uint64_t min_duration);
void ghb_backend_scan_list(GListModel *files, int titleindex, int preview_count, uint64_t min_duration);
