...
void
custom_tmp_changed_cb (GSettings *settings, char *key, GhbPrefsDialog *self)
{
...
ghb_prefs_dialog_finalize (GObject *object)
{
    ...
    g_signal_handlers_disconnect_by_func(ghb_prefs_get_gsettings(self->prefs), custom_tmp_changed_cb, self);
